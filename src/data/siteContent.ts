...
export const siteContent = {
  uk: {
    ...
    hero: {
      ...
      imageAlt: 'Стікер привітної викладачки Fluyo School',
      lessonLabel: 'Онлайн',
      lessonValue: '1:1',
    ...
    contact: {
      ...
      text: 'Залиште заявку або напишіть Fluyo School у зручному каналі. Менеджер допоможе обрати викладача та формат.',
  ...
  en: {
    ...
    hero: {
      ...
      imageAlt: 'Friendly Fluyo School teacher sticker',
      lessonLabel: 'Online',
      lessonValue: '1:1',
    ...
    contact: {
      ...
      text: 'Leave a request or message Fluyo School in the channel that is easiest for you. The manager will help choose the teacher and format.',
